 ...
 */
public class VerifAbsence extends AsyncTask<ArrayList<String>,Void,Boolean> {
    ...
    protected Boolean doInBackground(ArrayList<String>... params) {
        ...
        String urletudiant ="http://esprit-tn.com/ws/VerifABS/verifAbsence/"+ URLEncoder.encode(classeid.get(3))+","+URLEncoder.encode(classeid.get(5))+","+URLEncoder.encode(classeid.get(1))+","+URLEncoder.encode(classeid.get(2))+","+URLEncoder.encode(classeid.get(0));
