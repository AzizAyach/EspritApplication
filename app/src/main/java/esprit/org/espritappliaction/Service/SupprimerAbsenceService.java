 ...
 */
public class SupprimerAbsenceService extends AsyncTask<ArrayList<String>,Void,Boolean> {
    ...
    protected Boolean doInBackground(ArrayList<String>... params) {
        ...
        String urletudiant ="http://esprit-tn.com/ws/ModifABS/DeletABS/"+ URLEncoder.encode(classeid.get(3))+","+URLEncoder.encode(classeid.get(1))+","+URLEncoder.encode(classeid.get(4))+","+URLEncoder.encode(classeid.get(2))+","+URLEncoder.encode(classeid.get(0))+","+URLEncoder.encode(classeid.get(5))+","+""+2;
